...
| L5 | **Email + uploads** | Poster upload fields | Resend ticket email (React Email, QR), forgot-password; Vercel Blob upload route | 2 h | Ticket email arrives with working link |
