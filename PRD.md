...
**Slot:** #2 · Budget ~38 h (v1 18 · v2 10 · v3 10) · Build second
...
### 3. Three versions — base → mid → advanced
Every project is cut this way (rule set 2026-09-15). v1 alone is a complete, sellable ticketing site.
...
Custom venue-layout editor (templates only) · refunds UI (only the automatic paid-after-expiry refund) · native scanner app (the check-in web page is enough) · real-money mode · multi-city · reserved standing/GA zones · promo codes · seat-map accessibility beyond keyboard + screen-reader seat list (full WCAG pass on the SVG map is a v3 stretch).
