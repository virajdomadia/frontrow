...
**Slot:** #2 · Budget ~52 h (v1 18 · v2 10 · v3 10 · v4 14) + add-ons only from time saved (up to 32 h, see [docs/07-plan.md](docs/07-plan.md#add-ons-only-from-time-saved)) · Build second
